...
const products = [
  {
    ...
    price: 250,
    discription:
      "A trendy, comfortable cotton T-shirt with unique graphic designs for everyday wear.",
  },
  {
    ...
    price: 1000,
    discription:
      "A lightweight serum enriched with hyaluronic acid for deep skin hydration and a radiant glow.",
  },
  {
    ...
    price: 1200,
    discription:
      "Compact earbuds with noise-cancellation and long battery life, perfect for on-the-go listening.",
  },
  {
    ...
    price: 500,
    discription:
      "A durable, insulated water bottle that keeps drinks hot or cold for hours, ideal for work or travel.",
  },
  {
